                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('mahasiswa.store') }}" id="myForm"> @csrf <div
                        ...
                        <div class="form-group"> <label for="Kelas">Kelas</label> <input type="Kelas" name="Kelas"
                                class="form-control" id="Kelas" aria-describedby="Nama"> </div>
                        ...
                        <div class="form-group"> <label for="Email">Email</label> <input type="Email"
                                name="Email" class="form-control" id="Email" aria-describedby="Email">
                        <div class="Tanggal_Lahir mb-2"> <label for="Tanggal_Lahir">Tanggal_Lahir</label> <input type="date"
                                name="Tanggal_Lahir" class="form-control" id="Tanggal_Lahir" aria-describedby="Tanggal_Lahir">
